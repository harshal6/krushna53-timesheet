...
class UserRoleTest extends ConfigEntityReferenceTestBase {
  ...
  protected function createTargetPluginInstance(array $configuration = []) {
    ...
    return new UserRole($configuration, 'user_role', [], $this->entityTypeManager->reveal(), $this->entityRepository->reveal(), $this->transliteration->reveal(), $this->typedConfigManager->reveal());
  }
