...
class ConfigEntityReferenceTest extends ConfigEntityReferenceTestBase {
  ...
  protected function createTargetPluginInstance(array $configuration = []) {
    ...
    return new ConfigEntityReference($configuration, 'config_entity_reference', [], $this->entityTypeManager->reveal(), $this->entityRepository->reveal(), $this->transliteration->reveal(), $this->typedConfigManager->reveal());
  }
